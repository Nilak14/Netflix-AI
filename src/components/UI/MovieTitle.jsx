...
const MovieTitle = ({movieTitle, movieOverview, open, movieID, type}) => {
  return (
    <article className="text-white ml-4 md:ml-10 mt-4 sm:mt-[10%]  absolute z-10 ">
      <div className="">
        ...
        <div className="flex gap-2 mt-4">
          <Link
            to={`/watch/${type}/${movieID}`}
            className="flex items-center gap-2 text-sm sm:text-lg bg-white text-black rounded-md px-2 sm:px-4 py-1 sm:py-2 md:px-8 hover:opacity-75 "
          >
