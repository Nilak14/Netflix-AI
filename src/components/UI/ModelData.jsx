  ...
  return (
    <section className="px-6 py-3 flex gap-2 justify-between ">
      <article className=" sm:w-[50%] flex flex-col items-start ">
        ...
        <div className=" font-bold tracking-wider flex items-center gap-3 mt-2">
        ...
        <p className="mt-2 tracking-wider text-justify">{data.overview}</p>
      </article>
      <article className=" hidden w-[50%] sm:flex flex-col items-end   tracking-wider">
        {/* produced */}
        <div className="flex  gap-1 flex-wrap items-end   w-[80%] ">
        ...
        {/* genres */}
        <div className="flex  gap-1 flex-wrap   w-[80%] mt-3">
          <span className="text-gray-400 font-bold">
